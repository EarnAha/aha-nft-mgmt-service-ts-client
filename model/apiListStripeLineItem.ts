...
*/
export class ApiListStripeLineItem {
    'object': ApiListStripeLineItem.ObjectEnum;
    'data': Array<StripeLineItem>;
    /**
    ...
    */
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        {
            "name": "object",
            "baseName": "object",
            "type": "ApiListStripeLineItem.ObjectEnum"
        },
        {
            "name": "data",
            "baseName": "data",
            "type": "Array<StripeLineItem>"
        },
        {
            "name": "hasMore",
            "baseName": "has_more",
    ...
    static getAttributeTypeMap() {
        return ApiListStripeLineItem.attributeTypeMap;
    }
}

export namespace ApiListStripeLineItem {
