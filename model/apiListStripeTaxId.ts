...
*/
export class ApiListStripeTaxId {
    'object': ApiListStripeTaxId.ObjectEnum;
    'data': Array<StripeTaxId>;
    /**
    ...
    */
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        {
            "name": "object",
            "baseName": "object",
            "type": "ApiListStripeTaxId.ObjectEnum"
        },
        {
            "name": "data",
            "baseName": "data",
            "type": "Array<StripeTaxId>"
        },
        {
            "name": "hasMore",
            "baseName": "has_more",
    ...
    static getAttributeTypeMap() {
        return ApiListStripeTaxId.attributeTypeMap;
    }
}

export namespace ApiListStripeTaxId {
