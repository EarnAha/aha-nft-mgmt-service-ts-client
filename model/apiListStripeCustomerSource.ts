...
*/
export class ApiListStripeCustomerSource {
    'object': ApiListStripeCustomerSource.ObjectEnum;
    'data': Array<StripeCustomerSource>;
    /**
    ...
    */
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        {
            "name": "object",
            "baseName": "object",
            "type": "ApiListStripeCustomerSource.ObjectEnum"
        },
        {
            "name": "data",
            "baseName": "data",
            "type": "Array<StripeCustomerSource>"
        },
        {
            "name": "hasMore",
            "baseName": "has_more",
    ...
    static getAttributeTypeMap() {
        return ApiListStripeCustomerSource.attributeTypeMap;
    }
}

export namespace ApiListStripeCustomerSource {
