...
*/
export class ApiListStripeBankAccountOrStripeCard {
    'object': ApiListStripeBankAccountOrStripeCard.ObjectEnum;
    'data': Array<ApiListStripeBankAccountOrStripeCardDataInner>;
    /**
    ...
    */
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        {
            "name": "object",
            "baseName": "object",
            "type": "ApiListStripeBankAccountOrStripeCard.ObjectEnum"
        },
        {
            "name": "data",
            "baseName": "data",
            "type": "Array<ApiListStripeBankAccountOrStripeCardDataInner>"
        },
        {
            "name": "hasMore",
            "baseName": "has_more",
    ...
    static getAttributeTypeMap() {
        return ApiListStripeBankAccountOrStripeCard.attributeTypeMap;
    }
}

export namespace ApiListStripeBankAccountOrStripeCard {
