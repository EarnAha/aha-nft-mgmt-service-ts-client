...
*/
export class ApiListStripeTransferReversal {
    'object': ApiListStripeTransferReversal.ObjectEnum;
    'data': Array<StripeTransferReversal>;
    /**
    ...
    */
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        {
            "name": "object",
            "baseName": "object",
            "type": "ApiListStripeTransferReversal.ObjectEnum"
        },
        {
            "name": "data",
            "baseName": "data",
            "type": "Array<StripeTransferReversal>"
        },
        {
            "name": "hasMore",
            "baseName": "has_more",
    ...
    static getAttributeTypeMap() {
        return ApiListStripeTransferReversal.attributeTypeMap;
    }
}

export namespace ApiListStripeTransferReversal {
