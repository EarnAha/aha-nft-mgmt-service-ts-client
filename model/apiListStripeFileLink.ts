...
*/
export class ApiListStripeFileLink {
    'object': ApiListStripeFileLink.ObjectEnum;
    ...
    */
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        {
            "name": "object",
            "baseName": "object",
            "type": "ApiListStripeFileLink.ObjectEnum"
        },
        {
            "name": "data",
            "baseName": "data",
    ...
    static getAttributeTypeMap() {
        return ApiListStripeFileLink.attributeTypeMap;
    }
}

export namespace ApiListStripeFileLink {
