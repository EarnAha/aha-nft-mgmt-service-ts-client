...
*/
export class ApiListStripeRefund {
    'object': ApiListStripeRefund.ObjectEnum;
    ...
    */
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        {
            "name": "object",
            "baseName": "object",
            "type": "ApiListStripeRefund.ObjectEnum"
        },
        {
            "name": "data",
            "baseName": "data",
    ...
    static getAttributeTypeMap() {
        return ApiListStripeRefund.attributeTypeMap;
    }
}

export namespace ApiListStripeRefund {
